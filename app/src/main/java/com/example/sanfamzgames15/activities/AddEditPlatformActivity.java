...
public class AddEditPlatformActivity extends AppCompatActivity {
    public static final String EXTRA_ID =
            "com.example.sanfamzgames15.activities.EXTRA_ID";
    public static final String EXTRA_TITLE =
            "com.example.sanfamzgames15.activities.EXTRA_TITLE";
    public static final String EXTRA_DEVELOPER =
            "com.example.sanfamzgames15.activities.EXTRA_DEVELOPER";
    public static final String EXTRA_LAUNCH =
            "com.example.sanfamzgames15.activities.EXTRA_LAUNCH";
